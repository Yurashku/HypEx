...
def run_abtest_cupac():
    try:
        ...
        print("ABTest CUPAC resume:")
        print(result_cupac.resume)

        print("\nVariance Reduction Report:")
        print(result_cupac.variance_reduction_report())

        print("\nВсе проверки прошли успешно!")
        return 0
    except Exception:
        print("Ошибка при выполнении теста CUPAC:")
        traceback.print_exc()
        return 1

if __name__ == "__main__":
    sys.exit(run_abtest_cupac())
